...
namespace JWTAuthentication.Areas.Jwt.AuthFilter
{
    public class JwtAuthenticationFilterAttribute : Attribute, IAuthenticationFilter
    {
        ...
        private readonly string _audience = "https://localhost:44310";

        private readonly string _validIssuer = "https://localhost:44310";
